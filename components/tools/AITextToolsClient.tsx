...
export function AITextToolsClient({ lang }: { lang: AppLocale }) {
  ...
  return (
    <>
      ...
      <section className="space-y-5 overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <label className="block">
          <div className="mb-2 flex items-center justify-between gap-3">
            <span className="font-semibold text-slate-900">{t('aiTool.input')}</span>
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
          <div className="mb-3 flex items-center justify-between gap-3">
            <p className="text-sm font-semibold text-slate-900">{t('aiTool.output')}</p>
      ...
      <section className="my-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <h2 className="mb-3 text-xl font-bold text-slate-950">{t('common.howItWorks')}</h2>
      ...
      <section className="my-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <h2 className="mb-3 text-xl font-bold text-slate-950">{t('common.faq')}</h2>
        <p className="leading-7 text-slate-600">
          {lang === 'ar'
