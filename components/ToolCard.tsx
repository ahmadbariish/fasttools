...
export function ToolCard({ href, icon, title, description, cta }: ToolCardProps) {
  return (
    <Link
      href={href}
    ...
    >
      ...
      <h3 className="mb-2 text-lg font-bold leading-snug text-slate-950">{title}</h3>

      <p className="mb-6 line-clamp-3 text-sm leading-6 text-slate-600">{description}</p>
